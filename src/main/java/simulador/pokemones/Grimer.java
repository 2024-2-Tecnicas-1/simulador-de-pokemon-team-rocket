...
public class Grimer extends Pokemon {
    ...
    public Grimer(String nombre, int salud, int atkFis, int atkEsp, int defEsp, int defFis, int bsalud, int batkFis, int batkEsp, int bdefEsp, int bdefFis, Estados estado, TipoPokemon tipo1, TipoPokemon tipo2, String mote) {
        super(nombre, salud, atkFis, atkEsp, defEsp, defFis, bsalud, batkFis, batkEsp, bdefEsp, bdefFis, estado, tipo1, tipo2, mote);
    }

    public Grimer(String mote) {
        super(mote);
    }
